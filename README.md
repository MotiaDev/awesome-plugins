# Awesome Motia Plugins [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

A curated list of awesome plugins, tools, and resources for the [Motia](https://github.com/MotiaDev/motia) ecosystem.
...
- [Motia Repository](https://github.com/MotiaDev/motia)
- [Plugin Development Guide](https://github.com/MotiaDev/motia/blob/main/packages/docs/content/docs/development-guide/plugins.mdx) - Comprehensive guide on creating plugins.
- [Workbench Documentation](https://github.com/MotiaDev/motia/blob/main/packages/docs/content/docs/concepts/workbench.mdx) - Concepts and architecture of the Motia workbench.
